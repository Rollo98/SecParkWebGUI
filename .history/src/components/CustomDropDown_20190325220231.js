    ...
    return (
      <div>
        ...
        {this.props.input.value === "Edit" && (
          <p>
            api call to get the licence plate of the logged person <br />here
            are your plates to edit
          </p>
        )}
        {this.props.input.value === "Delete" && (
          <p>
            api call to get the licence plate of the logged person here are your
            plates to delete
          </p>
        )}
      </div>
